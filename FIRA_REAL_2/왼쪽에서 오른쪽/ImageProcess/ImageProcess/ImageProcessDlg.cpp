...
int CImageProcessDlg::ThreadFunction2(void)
{
	...
	int time_interval2 = 1000;
	int time_interval3 = 800;
	int time_interval4 = 500;
	...
	while (Flag_Thread_State == 1)
	{
		...
		if (flag_time2 == 1) //time_interval2를 기준 간격으로 명령어 전달하는 부분 - Robot 함수 전달
		{
			...
			/////////////여기부터/////////////
			//if (P_Ball_x > 500)////////공격 영역
			//{
			//	
			//	if (Robot_Info[0][0] > 500)//로봇이 영역안에 있을때
			//	{
			//		Angle_Check(1, 0);
			//		LR_CHECK(1, P_Ball_x, P_Ball_y);
			//	if (P_Ball_x - Robot_Info[1][0] > 60 && Area_Count == 0)
			//	{
			//		
			//		SendData(1, 8);
			...
			//		printf("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
			//	}
			//	else if (P_Ball_x - Robot_Info[1][0] <= 60 && P_Ball_x - Robot_Info[1][0] > 45 && Area_Count == 0)
			//	{

			//		SendData(1, 9);
			//		printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
			//		printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
			//		printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
			//		printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
			//	}
			//	else if (P_Ball_x - Robot_Info[1][0] <= 45 && P_Ball_x - Robot_Info[1][0] > 30 && Area_Count == 0)
			//	{
			//		Kick(1);
			...
			///////////////여기까지///////////////
				...
				/*else if (P_Ball_x - Robot_Info[1][0] < 50 && P_Ball_x - Robot_Info[1][0] < 60)
				{
					Kick(1);
				}
			}*/
			...
			//Angle_Check(1, 0);
			//LR_CHECK(1, P_Ball_x, P_Ball_y);
			//if (Robot_Info[0][0] + 80 <= P_Ball_x)
			//{
			//	SendData(0, M_CenterRun50);
			//}
			//else if (Robot_Info[0][0] + 75 >= P_Ball_x&&Robot_Info[0][0] + 50 < P_Ball_x)///P_Ball_x>Robot_Info[0][0]+60
			//{
			//	SendData(0, M_CenterStep);
			//	
			//}//-60~-50
			//else if (Robot_Info[0][0] + 50 >= P_Ball_x&&Robot_Info[0][0] + 40 < P_Ball_x)//R-B<-60
			//{
			//	if (Robot_Info[0][1] + 20 >= P_Ball_y)
			//	{
			//		SendData(0, N_M_LeftShoot);
			//	}
			//	else if (Robot_Info[0][1] - 20 >= P_Ball_y)
			//	{
			//		SendData(0, N_M_RightShoot);
			//	}
			//	
			//}
			//else
			...
			/*else if (Robot_Info[0][0] - P_Ball_x>  -20)
			{
				SendData(0,N_M_RightShoot);
			...
			//Angle_Check(0, 0);
			//		LR_CHECK(0, P_Ball_x, P_Ball_y);
			//	if (P_Ball_x - Robot_Info[0][0] > 50 && Area_Count == 0)
			//	{
			//		
			//		SendData(0, 8);
			//		/*if (P_Ball_x - Robot_Info[1][0] > 60)
			...
			//		printf("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
			//	}
			//	else if (P_Ball_x - Robot_Info[0][0] <= 50 && P_Ball_x - Robot_Info[0][0] > 40 && Area_Count == 0)
			//	{
			...
			//		printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
			//	}
			//	else if (P_Ball_x - Robot_Info[0][0] <= 40 && P_Ball_x - Robot_Info[0][0] > 30 && Area_Count == 0)
			//	{
			//		Kick(0);
			//		printf("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk\n");
			//		printf("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk\n");
		...
		if (flag_time3 == 1) //time_interval2를 기준 간격으로 명령어 전달하는 부분 - Robot 함수 전달
		{
			...
			else
			{
				SendData(1, 8);
					...
					//if (P_Ball_x < 300)//골키퍼 라인에 있을때
					//{

					//	if (Robot_Info[1][0] <= P_Ball_x)//공이 앞에 있을때
					//	{
					//		Angle_Check(1, 0);
					//		LR_CHECK(1, P_Ball_x, P_Ball_y);
					//		if (Robot_Info[1][0] + 80 <= P_Ball_x)
					//		{
					//			SendData(1, Center_Run);
					//		}
					//		else if (Robot_Info[1][0] + 75 >= P_Ball_x&&Robot_Info[1][0] + 50 < P_Ball_x)///P_Ball_x>Robot_Info[0][0]+60
					//		{
					//			SendData(1, F_Center_Run);
					//			
					//		}//-60~-50
					//		else if (Robot_Info[1][0] + 50 >= P_Ball_x&&Robot_Info[1][0] + 40 < P_Ball_x)//R-B<-60
					//		{
					//			if (Robot_Info[1][1] + 20 >= P_Ball_y)
					//			{
					//				SendData(1, Left_Kick);
					//			}
					//			else if (Robot_Info[1][1] - 20 >= P_Ball_y)
					//			{
					//				SendData(1, Right_Kick);
					//			}
					//	}
					//	else//공이 뒤에 있을때
					//	{
					...
					//}
					//else if (P_Ball_x >= 300 && P_Ball_x < 500)//수비 라인에 있을때
					//{

					//}
					//else if (P_Ball_x >= 500 && P_Ball_x < 900)//공격 라인에 있을때
					//{

					//}
					//////////////////////////////////////필요한 각도 설정////////////////////////////////////

					//Ball_Angle_Check(0, P_Ball_x, P_Ball_y);



					//if (P_Ball_x < 300)//공이 영역 안에
					//{
					//	if (Robot_Info[1][0] < 100)//공이 근처에 있을때
					//	{
					//		LR_CHECK(1, P_Ball_x, P_Ball_y);
					//		if (P_Ball_x>Robot_Info[1][0])
					//		{
					//			SendData(1, Keeper_Motion);
					//		}
					//	}
					//	else//자신의 영역으로 돌아가기
					//	{
					//		LR_CHECK(1, 150, P_Ball_y);
					//		if (150 - Robot_Info[1][0]<0)
					//		{
					//			SendData(1, Back_Run);
					//		}
					//	}
					...
					//else if (P_Ball_x >= 300)
					//{
					//	if (Robot_Info[1][0] < 300)//공이 근처에 있을때
					//	{
					//		LR_CHECK(1, P_Ball_x, P_Ball_y);
					//		
					//	}
					...
					//if (P_Ball_x - 60 > Robot_Info[1][0] && Area_Count == 0)//count=0이고 앞으로 60만큼 차이 날때
					//{
					//	SendData(1, Center_Run);
					//	printf("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
					//	printf("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
					...
					//	
					//}
					//else if (P_Ball_x - 60 <= Robot_Info[1][0] && P_Ball_x - 40 > Robot_Info[1][0] && Area_Count == 0)//count=0이고 앞으로 60~50 사이만큼 차이 날때
					//{
					//	SendData(1, F_Center_Run);
					//	printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
					//	printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
					...
					//	printf("jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
					//}
					//else if (P_Ball_x - 40 <= Robot_Info[1][0] && P_Ball_x - 30 > Robot_Info[1][0] && Area_Count == 0)//count=0 앞으로 50~40 사이만큼 차이 날때
					//{
					//	Kick(1);
					//	printf("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk\n");
					//	printf("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk\n");
		...
		if (flag_time4 == 1) //time_interval2를 기준 간격으로 명령어 전달하는 부분 - Robot 함수 전달
		{
			...
			if (Robot_Info[2][0] > 155)
			{
				SendData(2, Back_Run);
					...
					/*else if (P_Ball_x <= 130 && P_Ball_x>=125)
					{
						LR_CHECK(2, P_Ball_x, P_Ball_y);
						SendData(2, Keeper_Motion);
					}*/
					//else if (P_Ball_x >= 170)///공이 골키퍼 영역 나감
					//{
					//	LR_CHECK(2, P_Ball_x, P_Ball_y);
					//}
					//else////////////공이 골대 근처에 있을때 뒤로 가서 막아야함
					//{
					//	
					//	if (Robot_Info[2][0] > P_Ball_x+35)
					//	{
					//		SendData(2, Back_Run);
					//	}
				...
				//else if (Robot_Info[2][0] >= 200)//로봇이 수비 및 공격 진영으로 영역을 나감
				//{
				//	SendData(2, Back_Run);
				//}/////////골대 영역으로 나갔을때 생각?
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (Flag_Run == 1)
		{
			...
			for (k = 0; k < 3; k++)
			{
				...
				else if (10 < count_Blue[k] && count_Blue[k] < 300)
				{
					*Robot_ID[k] = 3;
...
//printf("Robot_Info[0][0]=%d  Robot_Info[0][1]=%d\n",Robot_Info[0][0],Robot_Info[0][1]);
//printf("차이x=%d   차이y=%d\n", P_Ball_x - Robot_Info[0][0], P_Ball_y - Robot_Info[0][1]);
if (Robot_Info[0][0] + 60 < P_Ball_x)
{
	destCheck++;
}
else
...
printf("destCheck=%d\n", destCheck);
	...
	//const unsigned long Motion_table[32] = {
	//	//0~31
	//	0x000, 0x000, 0x000, 0x000, 0x000, 7, 8, 0x000,//0~7
	//	4, 5, 6, 0x000, 1, 2, 3, 9,//8~15
	//	10, 11, 12, 13, 0x000, 0x000, 0x000, 0x000030,//16~23
	//	0x010000, 0x400000, 0x000, 0x000, 0x000, 0x000, 0x000002, 0x001000,//24~31
	//};
	...
	void CImageProcessDlg::RobotMove(int num, int Target_x, int Target_y)
	{
		...
		/*int distancematerial[3] = { 0, };
		double distance[3] = { 0 ,};*/

		/*distancematerial[num] = abs(((Target_x - *R_Data[num][0])*(Target_x - *R_Data[num][0])) + ((Target_y - *R_Data[num][1])*(Target_y - *R_Data[num][1])));
		distance[num] = sqrt(distancematerial[num]);
		printf("로봇과 공의 거리 : %lf \n", (int)distance[num]);*/
		//printf("RobotMove Target_x=%d Target_y=%d\n", Target_x, Target_y);
		//printf("RobotMove R_data x=%d R_data y=%d\n", *R_Data[0][0], *R_Data[0][1]);
		//printf("RObotMove rawdistance=%d\n", distancematerial);
		//printf("RobotMove Distance=%d\n", (int)distance[0]);


		/////////////////////
			Angle_Check(num, 0);
			LR_CHECK(num, Target_x, Target_y);
			if (Robot_Info[num][2] > 170 && Robot_Info[num][2] < 190)
			{
				if (Target_x - 100  >Robot_Info[num][0])
				{
					SendData(num, Center_Run);
					printf("간다간다\n");
				}
				/*else if (Target_x - 50  <Robot_Info[num][0] && Target_x - 40  >Robot_Info[num][0])
				{
					SendData(num, F_Center_Run);
				}*/
			}
		///////////////////////
		...
		if (Target_x - Robot_Info[num][0] > 10)
		{
			SendData(num, 0); //뒤
		}
		else if (Target_x - Robot_Info[num][0] <15)
		{
			SendData(num, N_M_LeftShoot);
		}*/
	...
	/*void CImageProcessDlg::FrontMove(int num, int Target_x, int Target_y)
	{
		LR_CHECK(num, Target_x, Target_y);
		if (Target_x - Robot_Info[num][0] > 35)
		{
			SendData(num, 8);
		}
		if (Target_x - Robot_Info[num][0] > 35 && Target_x - Robot_Info[num][0] < 80)
		{
			SendData(num, 9);
		}
	}*/
	...
	void CImageProcessDlg::BackMove2(int num, int Target_x, int Target_y)///골키퍼 BackMove
	{
		...
		if (Area_Count3 == 1)
		{
			...
			if (Robot_Info[num][0] + 70 > Target_x)
			{
				...
				{
					LR_CHECK(num, Target_x, Target_y - 70);
				}
				else if (Target_y < Robot_Info[num][1]) //공이 더 위쪽에 잇으면
				{
					LR_CHECK(num, Target_x, Target_y + 70);
